...
<head>
  ...
  <title>@yield('title','Bảng sản phẩm')</title>
    ...
    <ul class="navbar-nav ml-auto">
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="#">
            <img  style="width:40px ; position: relative ; top:-8px" src="{{ asset('dist/img/avatar2.png') }}" class="img-circle elevation-2" alt="User Image">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="" class="brand-link">
      <img src="{{ asset('dist/img/AdminLTELogo.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Chào {{ Auth::user()->name }}</span>
    </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('makerList') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('carModelList') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Danh sách mẫu xe</p>
                </a>
              </li>
            </ul>
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('carList') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
